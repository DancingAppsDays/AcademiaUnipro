...
import { NgbDateStruct, NgbCalendar, NgbDatepickerModule, NgbAccordionModule } from '@ng-bootstrap/ng-bootstrap';
...
import { CourseCurriculum, CurriculumService } from '../../core/services/curriculum.service';
...
export class CourseDetailComponent implements OnInit, AfterViewInit {
  ...
  courseCurriculum: CourseCurriculum | null = null;
  hasCurriculum = false;
  ...
  private loadCurriculum(courseId: string): void {
    this.curriculumService.getCurriculumForCourse(courseId).subscribe(curriculum => {
      this.courseCurriculum = curriculum;
      this.hasCurriculum = this.curriculumService.hasCurriculumForCourse(courseId);
      console.log('Curriculum loaded:', this.hasCurriculum ? 'specific' : 'default');
    });
  }
